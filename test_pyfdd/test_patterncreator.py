...
from pyfdd import Lib2dl, PatternCreator, DataPattern, FitManager, BkgPattern, BackgroundTools
...
class TestPatternCreator(unittest.TestCase):
    ...
    def test_pattern_with_background(self):
        ...
        gen = PatternCreator(lib, xmesh, ymesh, simulations=1, sub_pixels=5,
                             background_pattern= btools.get_smoothed_background(bkg_patt), background_factor=5,
